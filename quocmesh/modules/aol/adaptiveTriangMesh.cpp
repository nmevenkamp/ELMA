...
template< typename RealType, typename TriangleType>
void AdaptiveFETriangMesh<RealType, TriangleType>::plot2DProjection( string filename, FormatType format, bool neighbours, bool marked ) const {
    ...
    switch ( format )
    {
        ...
        case POSTSCRIPT:
        {
            ...
            if ( file.is_open() )
            {
                ...
                file << "set size square 1, 1.4285715" << endl;
                file << "unset border" << endl;
                file << "set xtics nomirror" << endl;
                file << "set ytics nomirror" << endl;
                file << "plot ";
        ...
        case JPG:
        {
            ...
            if ( file.is_open() )
            {
                file << "set terminal jpeg large size 800,800 enhanced" << endl;
